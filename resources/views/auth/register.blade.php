        ...
        <x-jet-authentication-card>
            ...
            <div
                ...
                <h1 class="text-white text-2xl font-serif font-bold leading-normal mt-0 mb-2"
                    style="margin-bottom: 0px;">Registro</h1>
            </div>
            <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 border-2">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="p-4">
                        <div class="mb-12 px-4 bg-bb">
                            <div class="w-full relative h-11">
                                <span type="name"
                                    class="material-icons p-0 text-gray-600 text-opacity-60 border-none absolute top-1/2 right-0 transform -translate-y-1/2 text-2xl far fa-user"></span>
                                ...
                                <label
                                    ...
                                    <span class="absolute -top-4 transition-all duration-300">Name</span>
                                </label>
                            </div>
                        </div>
                        <div class="mb-12 px-4 bg-bb">
                        ...
                        <div class="mb-12 px-4 bg-bb">
                            <div class="w-full relative h-11">
                                ...
                                <label
                                    class="text-gray-500 absolute left-0 -top-0.5 w-full h-full border-gray-300 pointer-events-none border border-t-0 border-l-0 border-r-0 border-b-1">
                                    <span
                                        class="absolute -top-4 transition-all duration-300">Password confirmation</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-2">
                        <div class="flex justify-center bg-bb">
                            <button
                                class="flex items-center justify-center gap-1 font-bold outline-none uppercase tracking-wider focus:outline-none focus:shadow-none transition-all border-2 duration-300 rounded-lg py-3 px-7 text-sm leading-relaxed bg-transparent text-light-blue-500 hover:bg-light-blue-50 hover:text-light-blue-700 hover:bg-light-blue-50 active:bg-light-blue-100"
                                style="position: relative; overflow: hidden;">Register</button>
                        </div>
                    </div>
