<div>
    <x-errors></x-errors>
    <div class="md:grid md:grid-cols-3 md:gap-6" x-data="{ edit: false }">
        <div class="md:col-span-2">
            <div class="m-5 sm:px-0 shadow-sm grid grid-cols-8">
                <p class="text-sm font-bold text-center pb-4 inline-block sm:col-span-4 col-span-3 relative">
                    {{ $template->name }}
                </p>
            ...
            <div class="w-full bg-white p-3 text-center mx-auto border mb-3 rounded-md flex flex-col">
                <div x-show="!edit">
                    <div x-data="{ opened_option: null }">
                                    ...
                                    @if (count($list) > 0)
                                        @foreach ($list as $var)
                                            <div>
                                                ...
                                                <input placeholder="agregar descripcion" type="text"
                        ...
                        <h2>
                            <button type="button" @click="opened_option = opened_option == 2 ? null : 2"
                                class="flex items-center focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 justify-between p-5 w-full font-medium border border-gray-200 dark:border-gray-700 border-b-0 text-left text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800">
                                <span>Anexos {{ count($attachments) }}</span>
                            </button>
                        </h2>
                                    ...
                                    <div class="m-2">
                                        ...
                                        <div x-show="opened_tab=={{ $key }}"
                                            ...
                                            <div class="m-1">
                                                ...
                                                <input type="text"
                                                    class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    wire:model="attachments.{{ $loop->index }}.nombre">
                                            </div>
                                            ...
                                            <div class="m-1">
                                                ...
                                                <select
                                                    class="block p-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    wire:model="attachments.{{ $loop->index }}.allowed_types_id">
                                                    <option value="" selected>Seleccione</option>
                                            ...
                                            <div class="m-1">
                                                ...
                                                <textarea
                                                    class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    wire:model="attachments.{{ $loop->index }}.comment"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="m-2 mt-3 flex justify-center">
                        ...
                        <button type="button"
                            class=" guardar-borrado flex items-center gap-4 text-sm px-3 py-2 rounded-lg bg-gradient-to-tr from-light-blue-500 to-light-blue-700 text-white shadow-md"
